    ...
    <Sbc>
      <div className='d-flex flex-wrap'>
        ...
        <div className='col-md-4 col-12'>
          ...
          <Link to='/ACTIVES'>
            <div className='finess mx-auto'>
              <button className='py-1 text-capitalize'>Actives</button>
            </div>
          </Link>
        </div>
        <div className='col-md-4 col-12'>
          <img
            ...
            src={catPic1}
          />
          <Link to='/PRESERVATIVES'>
            <div className='finess mx-auto'>
              <button className='py-1 text-capitalize'>Preservatives</button>
            </div>
          </Link>
        </div>
      </div>
