...
export default class Footer extends Component {
    ...
    return (
        <footer class="site-footer section bg-contrast">
                <div class="container py-4">
                    <div class="row gap-y">
                        ...
                        <div class="col-md-6 px-5">
                            ...
                            <p class="text-secondary text-center">By registering with us, you will receive right in your inbox all new features and updates. <span class="bold">Subscribe now!</span></p>
                            ...
                            <div class="response-message bbn"><i class="fas fa-envelope font-lg"></i>
                        ...
                        <div class="col-md-3">
                            ...
                            <nav class="nav">
                                <div class="d-flex"><i class="fas fa-map-marker mr-2"></i> 123 Street St, Your City, YC Your Country</div>
                ...
                <p class="brand bold copyright text-secondary text-center">Copyright © 2020 Cosmetic Formulator Depot.</p>
                <p class="small text-secondary text-center"><em>Design by</em><a href="#istagram">Blackgene Development</a></p>
            </footer>
    )
  }
}
